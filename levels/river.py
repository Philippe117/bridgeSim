...
def config(self):
    ...
    nodeC = WoodNode(pygame.Vector2(-4, -1.4), self)
    ...
    nodeD = WoodNode(pygame.Vector2(-2, -1.4), self)
    ...
    nodeB = PaveNode(pygame.Vector2(1, 0), self)
    nodeD = WoodNode(pygame.Vector2(0, -1.4), self)
    WoodLink(nodeC, nodeD, self)
    WoodLink(nodeA, nodeD, self)
    WoodLink(nodeB, nodeD, self)
    PaveLink(nodeA, nodeB, self)
    ...
    nodeA, nodeC = nodeB, nodeD
    nodeB = node5
    nodeD = WoodNode(pygame.Vector2(4, -1.4), self)
    WoodLink(nodeC, nodeD, self)
    WoodLink(nodeA, nodeD, self)
    WoodLink(nodeB, nodeD, self)
    PaveLink(nodeA, nodeB, self)
